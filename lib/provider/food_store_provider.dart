...
class FoodStoreProvider extends ChangeNotifier {
  final Map<String, List<FoodStoreModel>> _foodStoreList = {
    ...
    '챔피언스필드': [
      FoodStoreModel(storeName: 'BHC치킨', location: '1루 3층 104블럭', type: '치킨'),
      FoodStoreModel(storeName: 'CU', location: '1루 3층 109블럭', type: '편의점'),
      FoodStoreModel(
        storeName: 'STATION',
      ...
      FoodStoreModel(storeName: '마성떡볶이', location: '1루 3층 110블럭', type: '분식'),
      FoodStoreModel(storeName: '스트릿츄러스', location: '1루 3층 103블럭', type: '츄러스'),
      FoodStoreModel(storeName: '마왕족발', location: '1루 3층 111블럭', type: '족발'),
      FoodStoreModel(storeName: '파파존스', location: '1루 3층 112블럭', type: '피자'),
      FoodStoreModel(storeName: 'XOXO핫도그', location: '1루 4층', type: '핫도그'),
      FoodStoreModel(storeName: '광주원샷', location: '1루 4층', type: '치킨'),
      FoodStoreModel(storeName: '자문밖', location: '1루 4층', type: '삼겹정식'),
      FoodStoreModel(storeName: 'BHC치킨', location: '1루 5층', type: '치킨'),
      FoodStoreModel(storeName: '파파존스', location: '1루 5층', type: '피자'),
      FoodStoreModel(storeName: 'BHC치킨', location: '3루 3층 116블럭', type: '치킨'),
      FoodStoreModel(
        storeName: '요아정',
        location: '3루 3층 123블럭',
        type: '요거트 아이스크림',
      ),
      FoodStoreModel(storeName: 'CU', location: '3루 3층 121블럭', type: '편의점'),
      FoodStoreModel(
        storeName: 'BHC치킨 PUB',
      ...
      FoodStoreModel(storeName: '스트릿츄러스', location: '3루 3층 119블럭', type: '츄러스'),
      FoodStoreModel(storeName: '마성떡볶이', location: '3루 3층', type: '분식'),
      FoodStoreModel(storeName: '프랭크버거', location: '3루 3층 123블럭', type: '햄버거'),
      FoodStoreModel(storeName: '광주원샷', location: '3루 4층', type: '치킨'),
      FoodStoreModel(storeName: '자문밖', location: '3루 4층', type: '삼겹정식'),
      FoodStoreModel(storeName: '프랭크버거', location: '3루 4층 ', type: '햄버거'),
      FoodStoreModel(storeName: 'CU', location: '3루 5층 ', type: '편의점'),
      FoodStoreModel(storeName: '마성떡볶이', location: '3루 5층 ', type: '분식'),
      FoodStoreModel(storeName: 'INC COFFEE', location: '외부', type: '커피,음료'),
    ],
