...
class FoodStoreProvider extends ChangeNotifier {
  final Map<String, List<FoodStoreModel>> _foodStoreList = {
    ...
    '한화생명볼파크': [
      FoodStoreModel(storeName: 'BBQ치킨', location: '1층 107구역', type: '치킨'),
      FoodStoreModel(storeName: 'GS25', location: '1층 101구역', type: '편의점'),
      FoodStoreModel(storeName: '명랑핫도그', location: '1층 104구역', type: '핫도그'),
      FoodStoreModel(storeName: '원조 바로그집', location: '1루 111구역', type: '분식'),
      FoodStoreModel(storeName: '반올림피자', location: '1루 105구역', type: '피자'),
      FoodStoreModel(storeName: '북촌손만두', location: '1루 107구역', type: '만두'),
      FoodStoreModel(storeName: '선비꼬마김밥', location: '1루 111구역', type: '분식'),
      FoodStoreModel(storeName: '완미족발', location: '1루 109구역', type: '족발'),
      FoodStoreModel(
        storeName: '이글스브루어리/오수리',
        location: '1루 102구역',
        type: '버터구이 오징어',
      ),
      FoodStoreModel(storeName: '자담치킨', location: '1루 107구역', type: '치킨'),
      FoodStoreModel(storeName: 'BBQ치킨', location: '1층 101구역', type: '치킨'),
      FoodStoreModel(storeName: 'BBQ치킨', location: '중앙 100B구역', type: '치킨'),
      FoodStoreModel(storeName: '공차', location: '중앙 100C구역', type: '버블티'),
      FoodStoreModel(storeName: 'GS25', location: '중앙 100B구역', type: '편의점'),
      FoodStoreModel(storeName: '반올림피자', location: '중앙 100B구역', type: '피자'),
      FoodStoreModel(storeName: '완미족발', location: '중앙 100B구역', type: '족발'),
      FoodStoreModel(storeName: '은구비 커피', location: '중앙 100A구역', type: '커피,음료'),
      FoodStoreModel(storeName: '이글스브루어리', location: '중앙 100C구역', type: '맥주'),
      FoodStoreModel(storeName: '이닝스', location: '중앙 100C구역', type: '핫도그'),
      FoodStoreModel(storeName: '자담치킨', location: '중앙 100B구역', type: '치킨'),
      FoodStoreModel(storeName: 'GS25', location: '3루 124구역', type: '편의점'),
      FoodStoreModel(storeName: '구루닭', location: '3루 116구역', type: '닭구이'),
      FoodStoreModel(storeName: '농심가락', location: '3루 122구역', type: '국수'),
      FoodStoreModel(storeName: '마성떡볶이', location: '1층 113구역', type: '떡볶이'),
      FoodStoreModel(storeName: '브리쉘프라이', location: '3루 120구역', type: '감자튀김'),
      FoodStoreModel(storeName: '요아정', location: '3루 118구역', type: '요거트 아이스크림'),
      FoodStoreModel(storeName: '자담치킨', location: '1층 114구역', type: '치킨'),
      FoodStoreModel(storeName: 'BBQ치킨', location: '2층 211구역', type: '치킨'),
      FoodStoreModel(storeName: 'EST1985이닝스', location: '2층 201구역', type: '펍'),
      ...
      FoodStoreModel(storeName: '자담치킨', location: '1루 2층 202구역', type: '치킨'),
      FoodStoreModel(storeName: '고투웍', location: '3루 2층 더본테이스티', type: '중식'),
      FoodStoreModel(storeName: '백스비어', location: '3루 2층 더본테이스티', type: '맥주'),
      FoodStoreModel(storeName: '빽보이피자', location: '3루 2층 더본테이스티', type: '피자'),
      FoodStoreModel(storeName: '새마을식당', location: '3루 2층 더본테이스티', type: '고기'),
      FoodStoreModel(storeName: '역전우동', location: '3루 2층 더본테이스티', type: '우동'),
      FoodStoreModel(storeName: '연돈볼카츠', location: '3루 2층 더본테이스티', type: '카츠'),
      FoodStoreModel(storeName: '한신포차', location: '3루 2층 더본테이스티', type: '포차'),
      FoodStoreModel(storeName: '스플래시존', location: '4층 스플래시존', type: '바,스낵'),
      FoodStoreModel(storeName: 'GS25', location: '1층 외부', type: '편의점'),
      FoodStoreModel(storeName: '빽다방 빵연구소', location: '1층 외부', type: '빵'),
    ],
